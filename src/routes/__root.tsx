...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rosses Ananda — Authentic Ayurveda in Kerala" },
      {
        name: "description",
        content:
          "Personally arranged Ayurveda journeys in Kerala for European guests: consultations, Panchakarma, accommodation and transfers, coordinated by someone you can trust.",
      },
      { property: "og:site_name", content: "Rosses Ananda" },
